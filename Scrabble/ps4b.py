...
def playGame(wordList):
    ...
    while True:
        ...
        while True:
            ...
            if whoPlays == 'u':
                playHandWithThisPlayer = playHand
                break
            elif whoPlays == 'c':
                playHandWithThisPlayer = compPlayHand
                break
            else:
                print('Invalid command.', end = '\n\n')
        print()

        playHandWithThisPlayer(lastPlayedHand, wordList, HAND_SIZE)
...
if __name__ == '__main__':
    # get only each n-th word
    n = 1
    wordList = loadWords()[::n]
    playGame(wordList)
